...
BEGIN {
    ...
    require '/home/cyg/mqtt_x86/mqtt.client/openssl/openssl-3.5.4/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/cyg/mqtt_x86/mqtt.client/openssl/openssl-3.5.4/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/home/cyg/mqtt_x86/mqtt.client/openssl/openssl-3.5.4/test/default-and-jitter.cnf';
    shift;
